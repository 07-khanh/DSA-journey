...
>[!NOTE] Minimum number of nodes in AVL Tree
Denote $N(h)$ to be minimum # nodes in AVL Tree of height $h$.
We will prove that: $$N(h) = F_{h+3}-1$$
...
$$N(0) = 1$$$h = 1$: A root with one child (height $0$).
...
The exact relationship is:$$N(h) = F_{h+3} - 1$$
<img src="/trees/AVLTree/images/image-1.png"></a>
...
<img src="/trees/AVLTree/images/image-4.png"></a>
**SINGLE ROTATIONS**

<img src="/trees/AVLTree/images/image-3.png"></a>
...
<img src="/trees/AVLTree/images/image-2.png"></a>
...
<img src="/trees/AVLTree/images/image-5.png"></a>
<img src="/trees/AVLTree/images/image-6.png"></a>
```cpp
GET_BALANCE(root)
...
<img src="/trees/AVLTree/images/image-7.png"></a>
<img src="/trees/AVLTree/images/image-8.png"></a>
```cpp
DELETE(node, key)
    if node is NULL 
        return node
